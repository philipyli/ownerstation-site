...
;(function($) {
    ...
    var LiteAccordion = function(elem, options) {
        ...
        var defaults = {
			...
			tabbing: true,							// enable tab spacing for title
			tabSpacing: 20,							// number of tabe spaces per tab interval (2nd tab = 20, 3rd tab = 40)
			tabInterval: 3							// tab spacing interval for restarting tab position
            ...
            core = {
                ...
                setSlidePositions : function() {
                    ...
                    header.each(function(index) {
						...
						// START MODIFICATIONS
						// ******************************						
						if (settings.tabbing == true)
						{
							var spaces = (index % settings.tabInterval) * settings.tabSpacing;
							var spaceText = " ";																		
							// Add the spaces to the span
							$(this).children('span').each( function() {
							
								for (var spaceCount = 0; spaceCount < spaces; spaceCount++)
								{									
									$(this).append("&nbsp;");
								}
							});
