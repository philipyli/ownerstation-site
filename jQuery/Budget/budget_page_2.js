...
window.showBudget = function(whichBudget)
	{
		...
		$jq("#budgetSelectionTable, .budget-selection").show();
...
window.hideAllBudgetItems = function()
	{
		...
		$jq("#budgetSelectionTable, .budget-selection, .div-table-row").each(function() {
...
$jq(document).ready(function($) {
  ...
  $jq(btnBudgets).click(function(){
	...
	$jq(budgetTotalDiv).html("<span style='font-size:16px;color: #088A29 !important;'>Total</span>:   $" + budgetSumLow + "        to        $" + budgetSumHigh);		
